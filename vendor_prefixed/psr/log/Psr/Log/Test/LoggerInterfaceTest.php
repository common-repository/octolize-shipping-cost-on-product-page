...
namespace OctolizeShippingCostOnProductPageVendor\Psr\Log\Test;

use OctolizeShippingCostOnProductPageVendor\Psr\Log\LoggerInterface;
use OctolizeShippingCostOnProductPageVendor\Psr\Log\LogLevel;
use OctolizeShippingCostOnProductPageVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('OctolizeShippingCostOnProductPageVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('OctolizeShippingCostOnProductPageVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('OctolizeShippingCostOnProductPageVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
