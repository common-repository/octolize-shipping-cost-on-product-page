...
use OctolizeShippingCostOnProductPageVendor\Swift_Message;
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\OctolizeShippingCostOnProductPageVendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
