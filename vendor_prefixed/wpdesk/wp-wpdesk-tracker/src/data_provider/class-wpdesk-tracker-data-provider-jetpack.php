...
if (!\class_exists('OctolizeShippingCostOnProductPageVendor\WPDesk_Tracker_Data_Provider_Jetpack')) {
    ...
    class WPDesk_Tracker_Data_Provider_Jetpack implements \WPDesk_Tracker_Data_Provider
    {
        ...
        public function get_data()
        {
            ...
            $data['jetpack_connected'] = \class_exists('OctolizeShippingCostOnProductPageVendor\Jetpack') && \is_callable('OctolizeShippingCostOnProductPageVendor\Jetpack::is_active') && Jetpack::is_active() ? 'yes' : 'no';
            $data['jetpack_is_staging'] = \class_exists('OctolizeShippingCostOnProductPageVendor\Jetpack') && \is_callable('OctolizeShippingCostOnProductPageVendor\Jetpack::is_staging_site') && Jetpack::is_staging_site() ? 'yes' : 'no';
