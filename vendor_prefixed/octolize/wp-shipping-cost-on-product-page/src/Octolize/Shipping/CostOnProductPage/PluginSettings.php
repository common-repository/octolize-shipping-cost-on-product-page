...
class PluginSettings
{
    ...
    {
        return wc_string_to_bool($this->get_options()[GeneralSettingsFields::ENABLED_FIELD] ?? 'no');
    }
    /**
     * @return string
     */
    ...
    {
        return wc_string_to_bool($this->get_options()[GeneralSettingsFields::VIRTUAL_PRODUCTS_STATUS_FIELD] ?? 'no');
    }
    /**
     * @return string[]
     */
