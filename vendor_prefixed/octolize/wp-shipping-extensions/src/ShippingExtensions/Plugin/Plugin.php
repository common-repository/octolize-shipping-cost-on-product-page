...
class Plugin implements JsonSerializable
{
    ...
    {
        return $this->category === PluginFactory::get_categories()[PluginFactory::CATEGORY_BUNDLES] ? __('Buy bundle →', 'octolize-shipping-cost-on-product-page') : __('Buy plugin →', 'octolize-shipping-cost-on-product-page');
    }
}
