...
class PluginLinks implements Hookable
{
    ...
    private function get_extensions_link(): string
    {
        ...
        return '<a href="' . esc_url($extensions_link) . '" style="color:#917dff;font-weight:bold;">' . _x('Extensions', 'Link on plugin list page', 'octolize-shipping-cost-on-product-page') . '</a>';
    }
}
