...
namespace OctolizeShippingCostOnProductPageVendor\Octolize\ShippingExtensions;

use OctolizeShippingCostOnProductPageVendor\Octolize\ShippingExtensions\Plugin\Plugin;
use OctolizeShippingCostOnProductPageVendor\Octolize\ShippingExtensions\Plugin\PluginFactory;
use OctolizeShippingCostOnProductPageVendor\Octolize\ShippingExtensions\Plugin\PluginSorter;
use OctolizeShippingCostOnProductPageVendor\Octolize\ShippingExtensions\Tracker\ViewPageTracker;
...
class Page implements Hookable
{
    ...
    {
        add_submenu_page(self::PARENT_SLUG, _x('Shipping Extensions', 'Page title', 'octolize-shipping-cost-on-product-page'), $this->get_menu_title(), 'manage_options', self::MENU_SLUG, [$this, 'render_page']);
    }
    /**
     * @return void
     */
    ...
    {
        $menu_title = nl2br(_x("Shipping\nExtensions", 'Menu Title', 'octolize-shipping-cost-on-product-page'));
